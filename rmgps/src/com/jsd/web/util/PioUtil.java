...
//    style.setFillForegroundColor(HSSFColor.GREY_25_PERCENT.index);
	...
	public HSSFCellStyle notehv10_BorderThin1(HSSFWorkbook wb, HSSFFont defaultFont10) {
		HSSFCellStyle curStyle = wb.createCellStyle();
		curStyle.setWrapText(true); // 换行

		curStyle.setFont(defaultFont10);
		curStyle.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER); // 单元格垂直居中
		curStyle.setFillBackgroundColor(HSSFColor.LIGHT_TURQUOISE.index);
		curStyle.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND);
		curStyle.setFillForegroundColor(HSSFColor.LIGHT_TURQUOISE.index);
		curStyle.setBorderTop(HSSFCellStyle.BORDER_THIN); // 实线右边框
		curStyle.setBorderRight(HSSFCellStyle.BORDER_THIN); // 实线右边框
		curStyle.setBorderBottom(HSSFCellStyle.BORDER_THIN); // 实线右边框
		curStyle.setBorderLeft(HSSFCellStyle.BORDER_THIN); // 实线右边框
	...
	public HSSFCellStyle notehv10_BorderThin2(HSSFWorkbook wb, HSSFFont defaultFont10) {
		HSSFCellStyle curStyle = wb.createCellStyle();
		curStyle.setWrapText(true); // 换行
